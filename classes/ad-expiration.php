 ...
 */
class VK_Adnetwork_Ad_Expiration {
    const POST_STATUS = 'vk_adnetwork_expired';
    const POST_META   = 'vk_adnetwork_expiration_time';
     ...
     */
    public function __construct( VK_Adnetwork_Ad $ad ) {
        $this->ad = $ad;

        add_filter( 'vk-adnetwork-save-options', [ $this, 'save_expiration_date' ], 10, 2 );
    }
     ...
     * @return array
     */
    public function save_expiration_date( $options, VK_Adnetwork_Ad $ad ) {
    ...
    public static function register_post_status() {
        register_post_status( self::POST_STATUS, [
            'label'   => esc_html__( 'Expired', 'vk-adnetwork' ),
            'private' => true,
        ] );
    }
